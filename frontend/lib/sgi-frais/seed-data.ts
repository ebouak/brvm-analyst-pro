...
export const SGI_FRAIS_SEED: SgiFrais[] = [
  ...
  base({ sgiNom: 'SOGEBOURSE', courtagePctMax: 0.8, droitsGardePctMin: 0.08, droitsGardePctMax: 0.5, droitsGardeFrequence: 'annuel', tenueCompteMontant: 2500, tenueCompteFrequence: 'trimestriel', depotMinimum: 500_000, notes: 'Conservation 0,50%/an (≤10M FCFA) ou 0,08%/an (>10M FCFA) — palier non modélisé, borne max retenue par défaut.' }),
