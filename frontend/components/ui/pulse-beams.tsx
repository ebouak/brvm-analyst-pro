...
export const PulseBeams = ({
  ...
  return (
    <div
      className={cn(
        // overflow-visible : ne coupe pas les beams qui débordent du conteneur.
    ...
    >
      ...
      {/* Beams masqués sur mobile (hero souvent trop dense) — visibles dès sm. */}
