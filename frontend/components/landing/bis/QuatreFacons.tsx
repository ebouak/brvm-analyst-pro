...
const V = {
  analyser: (
    <svg viewBox="0 0 320 150" aria-hidden="true"><rect width="320" height="150" fill="#0a1417" /><rect x="14" y="14" width="200" height="122" rx="8" fill="#0f1b1f" stroke="#2a3a40" /><text x="26" y="34" fontSize="11" fontFamily="monospace" fill="#56D7FD">BRVM-C</text><path d="M26 110 L60 96 L94 102 L128 78 L162 84 L196 60" fill="none" stroke="#3fe18b" strokeWidth="2" /><path d="M26 110 L60 96 L94 102 L128 78 L162 84 L196 60 V126 H26z" fill="#3fe18b" opacity=".12" /><rect x="228" y="14" width="78" height="122" rx="8" fill="#0f1b1f" stroke="#2a3a40" /><text x="240" y="34" fontSize="9" fontFamily="monospace" fill="#a3afb4">NOTE</text><text x="267" y="88" fontSize="44" fontFamily="monospace" fill="#56D7FD" textAnchor="middle">A</text><rect x="240" y="104" width="54" height="6" rx="3" fill="#3fe18b" /><rect x="240" y="116" width="36" height="6" rx="3" fill="#56D7FD" /></svg>
  ),
  surveiller: (
    <svg viewBox="0 0 320 150" aria-hidden="true"><rect width="320" height="150" fill="#0a1417" /><rect x="110" y="8" width="100" height="160" rx="14" fill="#0f1b1f" stroke="#2a3a40" /><rect x="122" y="40" width="76" height="46" rx="8" fill="#152229" stroke="#2a3a40" /><rect x="128" y="46" width="10" height="10" rx="3" fill="#56D7FD" /><text x="142" y="55" fontSize="8" fontFamily="sans-serif" fill="#FCFCFC">Alerte</text><text x="128" y="70" fontSize="8" fontFamily="monospace" fill="#3fe18b">SONATEL +5,2 %</text><text x="128" y="80" fontSize="7" fontFamily="sans-serif" fill="#a3afb4">Seuil atteint</text><rect x="122" y="96" width="76" height="28" rx="8" fill="#152229" stroke="#2a3a40" /><rect x="128" y="104" width="40" height="5" rx="2" fill="#4a5a60" /><rect x="128" y="113" width="60" height="5" rx="2" fill="#4a5a60" /></svg>
  ),
  simuler: (
    <svg viewBox="0 0 320 150" aria-hidden="true"><rect width="320" height="150" fill="#0a1417" /><rect x="14" y="14" width="292" height="122" rx="8" fill="#0f1b1f" stroke="#2a3a40" /><text x="26" y="34" fontSize="11" fontFamily="sans-serif" fill="#FCFCFC">Simulateur</text><path d="M26 108 L66 100 L106 104 L146 82 L186 86 L226 62 L262 50" fill="none" stroke="#56D7FD" strokeWidth="2" /><path d="M26 112 L66 108 L106 110 L146 98 L186 100 L226 88 L262 84" fill="none" stroke="#c9a23a" strokeWidth="2" /><rect x="216" y="22" width="80" height="30" rx="6" fill="#123b2a" stroke="#3fe18b" /><text x="256" y="36" fontSize="11" fontFamily="monospace" fill="#3fe18b" textAnchor="middle">+28,4 %</text><text x="256" y="46" fontSize="7" fontFamily="sans-serif" fill="#a3afb4" textAnchor="middle">avec dividendes</text><text x="26" y="128" fontSize="8" fontFamily="sans-serif" fill="#a3afb4">Investissement 1 000 000 FCFA · 3 ans · dividendes inclus</text></svg>
  ),
  explorer: (
    <svg viewBox="0 0 320 150" aria-hidden="true"><rect width="320" height="150" fill="#0a1417" /><rect x="14" y="14" width="150" height="122" rx="8" fill="#0f1b1f" stroke="#2a3a40" />{['Actions', 'Obligations', 'Matières premières', 'SGI', 'Analyses & Academy', 'API & données'].map((t, i) => (<g key={t}><rect x="24" y={24 + i * 18} width="10" height="10" rx="3" fill="#56D7FD" /><text x="40" y={33 + i * 18} fontSize="9" fontFamily="sans-serif" fill="#FCFCFC">{t}</text></g>))}<circle cx="240" cy="75" r="48" fill="#152229" stroke="#2a3a40" /><path d="M200 60 Q240 40 280 62 M196 82 Q240 100 284 80 M240 27 Q225 75 240 123 M240 27 Q255 75 240 123" fill="none" stroke="#3a5a63" strokeWidth="1.2" /><path d="M222 58 c6 -4 12 2 10 8 c-2 6 4 10 -2 14 c-6 4 -14 -2 -12 -8 c2 -6 -2 -10 4 -14z" fill="#c9a23a" opacity=".85" /></svg>
  ),
};

const COLONNES: Colonne[] = [
  { k: '01', t: 'Analyser', d: 'Comprendre ce qui vaut une action.', c: '#1f6fb3', bg: '#e4eef9', href: '/societes', visuel: V.analyser, outils: [
  ...
  { k: '02', t: 'Surveiller', d: 'Ne rien manquer de la séance.', c: '#2f9e6b', bg: '#e3f4ea', href: '/portefeuille', visuel: V.surveiller, outils: [
  ...
  { k: '03', t: 'Simuler', d: 'Éprouver une décision avant de la prendre.', c: '#b8860b', bg: '#fbf1d8', href: '/simulateur', visuel: V.simuler, outils: [
  ...
  { k: '04', t: 'Explorer', d: 'Élargir au-delà des actions.', c: '#6b4fbb', bg: '#ece6f7', href: '/obligations', visuel: V.explorer, outils: [
  ...
  return (
    <section className="facons" aria-labelledby="h-facons">
      <div className="facons-head">
        ...
        <div className="annot-2" aria-hidden="true"><span className="hand">Des outils concrets<br />pour aller plus loin.</span><svg className="stroke" viewBox="0 0 90 8"><path d="M2 5 C 25 1, 60 8, 88 3" fill="none" stroke="#1ba8c9" strokeWidth="3" strokeLinecap="round" /></svg></div>
      </div>
      <div className="cols">
        {COLONNES.map((col) => (
